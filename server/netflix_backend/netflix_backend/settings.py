...
SECRET_KEY = '^f&hblsq$s0%*w91j%3)$4wf+%s*1yi*6s&%2+zi^k_p+3-@7t'
...
DATABASES = { # Edit the DATABASES part to the following
    'default': {
        ...
        'NAME': 'netflix', # Your database name
        'USER': 'root', # root is the default user for MySQL
        'PASSWORD': 'password', # Password is blank by default
        'HOST': 'mysql_db',
        'PORT': '3306',
    }
}
...
# CORS Settings 
# https://stackoverflow.com/a/38162454/3161273
